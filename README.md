# GemFiDiamond Hardhat Implementation

This project is a test project for TheSaudis
...
1. Clone this repo:
```console
git clone git@github.com:mumulei333/gemfi-mask-diamond.git
```

2. Install NPM packages:
```console
cd gemfi-mask-diamond
npm install
```
